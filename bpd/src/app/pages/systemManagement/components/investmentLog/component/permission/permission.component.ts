...
export class Permission {
    ...
    public managementCheckBoxs: any[] = [];
    ...
    public setPersonalAuthority: Boolean;
    public msgs: Message[];
    ...
    getReview(data) {
        ...
        if (this.selectedRole) {
            this.httpService.get('/bpd-proj/bpd/rolePermission/getPermIdsByRoleCodeAndRolePermType?' + Number(new Date()) + '&roleCode=' + this.selectedRole + '&rolePermType=2')
                .subscribe(data => {
                    // 选中树表回显
    ...
    onSelfCheckboxChange($event) {
        ...
        //     if  (this.selectedSelfValues[i] == "sgm05") {
        //         flag = false;
        //     }
        // }
        // if (!flag) {
    ...
    authorityClick($event, data) {
        ...
        //     this.httpService.get('/bpd-proj/bpd/platform/getPlatformCombobox')
        //         .subscribe(data => {
        //             if (data.length != 0) {
