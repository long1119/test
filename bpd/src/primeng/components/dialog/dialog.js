...
var Dialog = (function () {
    ...
    Dialog.prototype.show = function () {
        ...
        this.container.style.zIndex = String(domhandler_1.DomHandler.zindex+=2);
        this.enableModality();
    };
    ...
    Dialog.prototype.center = function () {
        ...
        // console.log(viewport.height,elementHeight)
    ...
    Dialog.prototype.onDrag = function (event) {
        if (this.dragging) {
            ...
            var dialogWidth = this.domHandler.getWidth(this.container);
            var dialogHeight = this.domHandler.getOuterHeight(this.contentContainer);
            ...
            if(screenWidth-dialogWidth-leftPos<0) {
                this.container.style.left = screenWidth-dialogWidth + 'px';
                this.dragging = false;
            }
            if(screenHeight-dialogHeight-topPos-45<0) {
                this.container.style.top = screenHeight-dialogHeight-45 + 'px';
                this.dragging = false;
            }
        }
    };
