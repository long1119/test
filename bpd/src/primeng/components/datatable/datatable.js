...
var DataTable = (function () {
    ...
    DataTable.prototype.ngAfterViewChecked = function () {
        ...
        if (this.dataChanged) {
            var scrollBarWidth = this.domHandler.calculateScrollbarWidth();
            var _scrollHeight = this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-body")[0] ? this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-body")[0].scrollHeight : 0;
            var _clientHeight = this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-body")[0] ? this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-body")[0].clientHeight : 0;
            var _offsetHeight = this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-body")[0] ? this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-body")[0].offsetHeight : 0;
            if(_scrollHeight && _clientHeight && _offsetHeight) {
                if(_scrollHeight>_clientHeight||_offsetHeight>_clientHeight) {
                    this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-header-box")[0].style.marginRight = scrollBarWidth + "px";
                } else {
                    this.el.nativeElement.getElementsByClassName("ui-datatable-scrollable-header-box")[0].style.marginRight = "0px";
                }
            }
            this.dataChanged = false;
        }
